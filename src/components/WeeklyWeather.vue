...
#wf_breadcrumb ul li:nth-child(1)::before {
  background: green;
}
#wf_breadcrumb ul li:nth-child(2)::before {
  background: red;
}
#wf_breadcrumb ul li:nth-child(3)::before {
  background: blue;
}
#wf_breadcrumb ul li:nth-child(4)::before {
  background: white;
}
#wf_breadcrumb ul li:nth-child(5)::before {
  background: yellow;
}
#wf_breadcrumb ul li:nth-child(6)::before {
  background: #0176f4;
}
